...
void estRunLevel_CABAC               (Slice *currSlice, Macroblock* currMB, int context);
...
void init_trellis_data_4x4_CAVLC(int **tblock, int block_x, int qp_per, int qp_rem, 
                         int **levelscale, int **leveloffset, const byte *p_scan, Macroblock *currMB,  
                         levelDataStruct *dataLevel, int type);
int init_trellis_data_4x4_CABAC(int **tblock, int block_x, int qp_per, int qp_rem, 
                         int **levelscale, int **leveloffset, const byte *p_scan, Macroblock *currMB,  
                         levelDataStruct *dataLevel, int* kStart, int* kStop, int type);
void init_trellis_data_8x8_CAVLC(int **tblock, int block_x, int qp_per, int qp_rem, 
                         int **levelscale, int **leveloffset, const byte *p_scan, Macroblock *currMB,  
                         levelDataStruct levelData[4][16]);
int init_trellis_data_8x8_CABAC(int **tblock, int block_x, int qp_per, int qp_rem, 
                         int **levelscale, int **leveloffset, const byte *p_scan, Macroblock *currMB,  
