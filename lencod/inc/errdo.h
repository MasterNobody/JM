...
extern void init_error_conceal      (ImageParameters *p_Img, int concealment_type);
...
extern void UpdateDecoders          (ImageParameters *p_Img, InputParameters *p_Inp, StorablePicture *enc_pic);
extern void copy_conceal_picture    (ImageParameters *p_Img, StorablePicture *enc_pic, int decoder);
extern void errdo_get_best_block    (Macroblock *currMB, imgpel*** dec_img, imgpel*** mbY, int j0, int block_size);
extern int  allocate_errdo_mem      (ImageParameters *p_Img, InputParameters *p_Inp);
extern void free_errdo_mem          (ImageParameters *p_Img);
