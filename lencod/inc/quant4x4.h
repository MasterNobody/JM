...
extern int quant_ac4x4_normal (Macroblock *currMB, int **tblock, struct quant_methods *q_method, int type);
extern int quant_ac4x4_around (Macroblock *currMB, int **tblock, struct quant_methods *q_method, int type);
extern int quant_ac4x4_trellis(Macroblock *currMB, int **tblock, struct quant_methods *q_method, int type);
...
extern void rdoq_ac4x4_CAVLC  (Macroblock *currMB, int **tblock, struct quant_methods *q_method, int levelTrellis[16], int type);

extern void rdoq_ac4x4_CABAC  (Macroblock *currMB, int **tblock , struct quant_methods *q_method, int levelTrellis[16], int type);
