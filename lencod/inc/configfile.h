...
Mapping Map[] = {
    ...
    {"BSliceSkip",               &configinput.InterSearch[1][0],            0,   1.0,                       1,  0.0,              1.0              },
    ...
    {"DFDisableRefISlice",       &configinput.DFDisableIdc[1][I_SLICE],     0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableNRefISlice",      &configinput.DFDisableIdc[0][I_SLICE],     0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableRefPSlice",       &configinput.DFDisableIdc[1][P_SLICE],     0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableNRefPSlice",      &configinput.DFDisableIdc[0][P_SLICE],     0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableRefBSlice",       &configinput.DFDisableIdc[1][B_SLICE],     0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableNRefBSlice",      &configinput.DFDisableIdc[0][B_SLICE],     0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableRefSPSlice",      &configinput.DFDisableIdc[1][SP_SLICE],    0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableNRefSPSlice",     &configinput.DFDisableIdc[0][SP_SLICE],    0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableRefSISlice",      &configinput.DFDisableIdc[1][SI_SLICE],    0,   0.0,                       1,  0.0,              1.0              },
    {"DFDisableNRefSISlice",     &configinput.DFDisableIdc[0][SI_SLICE],    0,   0.0,                       1,  0.0,              1.0              },
