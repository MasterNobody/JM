...
#if TRACE
		sprintf(currSE->tracestring, "B_bidiret_fw_blk");
#endif
...
#if TRACE
		sprintf(currSE->tracestring, "B_bidiret_bw_blk");
#endif
...
#if TRACE
					sprintf(currSE->tracestring, " MVD(%d) ",k);
#endif
...
/************************************************************************
*
*  Name :       decode_one_macroblock_Bframe()
*
*  Description: decode one macroblock for a B frame
*
************************************************************************/
