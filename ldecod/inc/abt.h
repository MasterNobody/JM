...
extern char       ABT_2D_VLC_dec[NUM_2D_TABLES][64][2]; //   inverse of last table. generated automatically in read_coef_abt()
...
void idct_dequant_abt_B8   (int block8x8, int qp, int abt_mode, int blk_off_x, int blk_off_y, int curr_blk[B8_SIZE][B8_SIZE], struct img_par *img);
void idct_dequant_abt_sp   (int block8x8,         int abt_mode, int blk_off_x, int blk_off_y, int curr_blk[B8_SIZE][B8_SIZE], struct img_par *img);
